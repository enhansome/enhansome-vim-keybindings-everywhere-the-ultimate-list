...
[![Closed issues](https://img.shields.io/github/issues-closed/erikw/vim-keybindings-everywhere-the-ultimate-list?color=success)](https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/issues?q=is%3Aissue+is%3Aclosed) ⭐ 2,595 | 🐛 0 | 🌐 Shell | 📅 2026-09-02
[![Closed PRs](https://img.shields.io/github/issues-pr-closed/erikw/vim-keybindings-everywhere-the-ultimate-list?color=success)](https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/pulls?q=is%3Apr+is%3Aclosed) ⭐ 2,595 | 🐛 0 | 🌐 Shell | 📅 2026-09-02
...
[![Bump count of tools listed](https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/actions/workflows/bump_tool_count.yml/badge.svg)](https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/actions/workflows/bump_tool_count.yml) ⭐ 2,595 | 🐛 0 | 🌐 Shell | 📅 2026-09-02

[![Contributors](https://img.shields.io/github/contributors/erikw/vim-keybindings-everywhere-the-ultimate-list)](https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/graphs/contributors) ⭐ 2,595 | 🐛 0 | 🌐 Shell | 📅 2026-09-02 including these top contributors:<br> <a href = "https://github.com/erikw/vim-keybindings-everywhere-the-ultimate-list/graphs/contributors"> <img src = "https://contrib.rocks/image?repo=erikw/vim-keybindings-everywhere-the-ultimate-list&max=36"/> </a>
...
* :white\_check\_mark: [vimpdb](https://github.com/gotcha/vimpdb) ⭐ 205 | 🐛 7 | 🌐 Python | 📅 2017-02-19 - An integration of the Python debugger `pdb` and vim.
...
* :white\_check\_mark: [ptpython](https://github.com/prompt-toolkit/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21 - A better Python REPL. Start it with `ptpython --vi` or add `repl.vi_mode = True` to its `config.py`.
...
* [The Julia Programming Language](https://julialang.org/) - High-level, general-purpose dynamic programming language suited for numerical analysis and computational science
  * :heavy\_plus\_sign: [VimBindings.jl](https://github.com/caleb-allen/VimBindings.jl) ⭐ 124 | 🐛 28 | 🌐 Julia | 📅 2026-06-01 - A Julia package which emulates Vim directly in the Julia REPL
...
* [DBeaver](https://dbeaver.io/) - Free Universal Database Tool
  * :heavy\_plus\_sign: [Vrapper plugin](https://vrapper.sourceforge.net/home/) - Plugin adds vim bindings to SQL editor. Install it using instructions from <https://github.com/dbeaver/dbeaver/issues/8219> ⭐ 51,819 | 🐛 3,332 | 🌐 Java | 📅 2026-09-21

## E-Mail

* :white\_check\_mark: [sup](https://sup-heliotrope.github.io/) - a console-based email client for people with a lot of email with Vim-inspired [keyboard shortcuts](https://github.com/sup-heliotrope/sup/wiki/Keyboard-reference) ⭐ 971 | 🐛 73 | 🌐 Ruby | 📅 2026-07-19.
...
* [Thunderbird](https://www.thunderbird.net/en-US/)
  * :heavy\_plus\_sign: ~~[teledactyl](https://github.com/5digits/dactyl/tree/master/teledactyl) ⭐ 468 | 🐛 105 | 🌐 JavaScript | 📅 2017-06-16~~
...
* :white\_check\_mark: [nnn](https://github.com/jarun/nnn) ⭐ 21,983 | 🐛 1 | 🌐 C | 📅 2026-09-21 - TUI file manager.
* :white\_check\_mark: [ranger](https://github.com/ranger/ranger) ⭐ 17,409 | 🐛 897 | 🌐 Python | 📅 2026-09-09 - Another TUI file manager.
* :white\_check\_mark: [lf](https://github.com/gokcehan/lf) ⭐ 9,518 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - TUI file manager similar to ranger.
* :white\_check\_mark: [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-16 - TUI file manager.
* :white\_check\_mark: [felix](https://github.com/kyoheiu/felix) ⭐ 919 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager.
...
* [Visual Studio Code (VSCode)](https://code.visualstudio.com/)
  * :heavy\_plus\_sign: [VSCodeVim](https://marketplace.visualstudio.com/items?itemName=vscodevim.vim) - Vim emulation for Visual Studio Code. [GitHub](https://github.com/VSCodeVim/Vim) ⭐ 15,210 | 🐛 1,908 | 🌐 TypeScript | 📅 2026-09-19
  * :heavy\_plus\_sign: [VSCode Neovim](https://marketplace.visualstudio.com/items?itemName=asvetliakov.vscode-neovim) - Alternative to the VIM plugin, uses a full nvim instance in the background instead of just emulating VIM. [GitHub](https://github.com/vscode-neovim/vscode-neovim) ⭐ 7,740 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-21
* :white\_check\_mark: [XCode](https://developer.apple.com/xcode/) - Apple's IDE. Vim mode can be enabled under the "Editor" menu without the use of plugins.
  ...
  * :heavy\_plus\_sign: ~~[XVim2](https://github.com/XVimProject/XVim2) ⭐ 2,285 | 🐛 98 | 🌐 Objective-C | 📅 2023-01-14~~ plugin. Deprecated, use native keybindings (above) instead.
...
* [Geany](https://www.geany.org/)
  * :heavy\_plus\_sign: [vimode](https://github.com/geany/geany-plugins/blob/master/vimode/README) ⭐ 645 | 🐛 343 | 🌐 C | 📅 2026-07-11 - The vimode plugin can be enabled from the settings.
...
* DrRacket - IDE for learning the Racket language.
  * :heavy\_plus\_sign: ~~[DrRacket Vim Tool](https://github.com/takikawa/drracket-vim-tool) ⭐ 218 | 🐛 40 | 🌐 Racket | 📅 2025-09-20~~ - An IDE that aims to use the tools you wish to use(including Vim and Emacs).
...
* :white\_check\_mark: [hx](https://github.com/krpors/hx) ⭐ 211 | 🐛 1 | 🌐 C | 📅 2024-08-03 - Hex editor for the terminal with simple Vim-like keybindings.
...
* :white\_check\_mark: [glow](https://github.com/charmbracelet/glow) ⭐ 27,411 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - Terminal based markdown reader.
* :white\_check\_mark: [fx](https://github.com/antonmedv/fx) ⭐ 20,635 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - Terminal based JSON viewer.
* :white\_check\_mark: [gollum](https://github.com/gollum/gollum) ⭐ 14,327 | 🐛 91 | 🌐 Ruby | 📅 2025-11-24 - A Git-powered wiki with built-in Vim editing mode. Start with `--default-keybind vim`.
* :white\_check\_mark: [ly](https://github.com/fairyglade/ly) ⭐ 7,599 | 🐛 0 | 🌐 Zig | 📅 2026-09-08 - A TUI display manager. Supports vi-like movement. Edit this in your `/etc/ly/config.ini`
  ...
  * ```ini
    ...
    vi_mode = true
    ```
* :white\_check\_mark: [mdp](https://github.com/visit1985/mdp) ⭐ 5,279 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A command-line based markdown presentation tool.
...
* :white\_check\_mark: [stig](https://github.com/rndusr/stig) ⭐ 629 | 🐛 59 | 🌐 Python | 📅 2026-01-24 - TUI/CLI for the BitTorrent client Transmission.
...
* :white\_check\_mark: [cmus](https://github.com/cmus/cmus) ⭐ 6,247 | 🐛 221 | 🌐 C | 📅 2026-08-12 - A console music player with vim-like [keybindings](https://man.archlinux.org/man/cmus.1.en#KEYBINDINGS).
* :white\_check\_mark: [ncmpcpp](https://github.com/ncmpcpp/ncmpcpp) ⭐ 2,484 | 🐛 225 | 🌐 C++ | 📅 2026-09-19 - An ncurses client for [mpd](https://www.musicpd.org/). The navigation can quite easily be made to behave like vim with some keyboard configurations.
  * <details>
...
* YT Music
  * :white\_check\_mark: [vimyt](https://github.com/Sadoaz/vimyt) ⭐ 42 | 🐛 1 | 🌐 Go | 📅 2026-06-28 – TUI for YouTube Music with Vim-like keybindings.
* Spotify
  * :white\_check\_mark: [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,352 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - TUI for Spotify with Vim-like keybindings.
...
* :heavy\_plus\_sign: [Reaper-Keys](https://github.com/gwatcha/reaper-keys) ⭐ 202 | 🐛 1 | 🌐 Lua | 📅 2026-07-05 - Bringing a modal editor to the Reaper DAW.
...
* :white\_check\_mark: [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,693 | 🐛 117 | 🌐 C | 📅 2026-08-26 - Like sc but improved, a Vim-like spreadsheet calculator.
...
* Google Docs Editors suite
  * :heavy\_plus\_sign: [SheetKeys](https://github.com/philc/sheetkeys) ⭐ 334 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-26 - Browser extension (Chrome and Firefox) which adds Vim keybindings to Google Sheets.

## Pagers

* :white\_check\_mark: [bat](https://github.com/sharkdp/bat) ⭐ 60,526 | 🐛 518 | 🌐 Rust | 📅 2026-09-04
* :white\_check\_mark: [less](https://en.wikipedia.org/wiki/Less_\(Unix\))

## PDF Viewers

* :white\_check\_mark: [Sioyek](https://github.com/ahrm/sioyek) ⭐ 9,874 | 🐛 331 | 🌐 C | 📅 2026-09-19 - Both keyboard and (optionally) mouse focused. Configurable and has the possibility of adding and developing plugins.
...
* Preview\.app - macOS native document viewer:
  * :heavy\_plus\_sign: [preview-vim](https://github.com/xrisk/preview-vim) ⭐ 57 | 🐛 1 | 📅 2021-01-24 - Adds vim-like keybindings, works via Karabiner Elements.

## Personal Knowledge Management

* :white\_check\_mark: [Trilium](https://github.com/zadam/trilium) ⭐ 37,931 | 🐛 676 | 🌐 TypeScript | 📅 2026-09-21 - 'Enable Vim Keybindings' added to Options in early-2022
...
* [Logseq](https://logseq.com/)
  * :heavy\_plus\_sign: [logseq-plugin-vim-shortcuts](https://github.com/vipzhicheng/logseq-plugin-vim-shortcuts) ⭐ 408 | 🐛 22 | 🌐 TypeScript | 📅 2025-12-27 - normal mode commands deal with whole blocks, editing text is only possible in edit mode
...
* :white\_check\_mark: [iamb](https://github.com/ulyssa/iamb) ⭐ 1,286 | 🐛 109 | 🌐 Rust | 📅 2026-09-21 - A Matrix client for Vim addicts.
...
* :white\_check\_mark: [matui](https://github.com/pkulak/matui) ⭐ 124 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - a Matrix TUI with vim-like navigation.
...
* :white\_check\_mark: [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,553 | 🐛 1,050 | 🌐 Go | 📅 2026-09-21 - Simple terminal UI for git commands with Vim-like keybindings.

* :white\_check\_mark: [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,511 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - GitUI provides you with the comfort of a git GUI but right in your terminal.
  * instruction how to enable vi bindings - <https://github.com/extrawurst/gitui/blob/master/KEY_CONFIG.md> ⭐ 22,511 | 🐛 347 | 🌐 Rust | 📅 2026-08-04

* :white\_check\_mark: [tig](https://jonas.github.io/tig/) - Text interface for git. Works mostly like vim out of the box, but can be enhanced by sourcing these [keybindings](https://github.com/jonas/tig/blob/master/contrib/vim.tigrc) ⭐ 13,344 | 🐛 231 | 🌐 C | 📅 2026-09-19 in your `~/.tigrc`.
...
* :white\_check\_mark: [Bash](https://www.gnu.org/software/bash/) - The preferred method is to set Vi mode in `~/.inputrc` via readline, as you will get Vi mode automatically in all programs using the library. However, if you just want this for bash, put this in your bash startup file e.g., `~/.bashrc`:
  ...
  * :heavy\_plus\_sign: [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,751 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 (Bash Line Editor) - An interactive plugin `ble.sh` provides a better Vim mode as well as syntax highlighting and autosuggestions.  In addition to the above setting of `set -o vi` in `~/.bashrc` or `set editing-mode vi` in `~/.inputrc`, you can add the following settings in `~/.bashrc` to enable `ble.sh`.
...
* :white\_check\_mark: [zsh](https://en.wikipedia.org/wiki/Z_shell) - just put this in your ZSH startup file, most likely `~/.zshrc`:
  ...
  * :heavy\_plus\_sign: [zsh-vi-mode](https://github.com/jeffreytse/zsh-vi-mode) ⭐ 4,451 | 🐛 131 | 🌐 Shell | 📅 2026-07-19 - A better and friendlier Vim-mode plugin for zsh.
...
* :white\_check\_mark: [vim-anywhere](https://github.com/cknadler/vim-anywhere) ⭐ 3,769 | 🐛 43 | 🌐 Shell | 📅 2026-05-02 - Spawn a Vim buffer from any text input in the operating system.
* :white\_check\_mark: [warpd](https://github.com/rvaiya/warpd) ⭐ 3,633 | 🐛 108 | 🌐 C | 📅 2024-07-12 - A modal keyboard-driven interface for mouse manipulation, Linux (X11/Wayland)
* :white\_check\_mark: [win-vind](https://github.com/pit-ray/win-vind) ⚠️ Archived - Control the Windows GUI in the same way as Vim.
* :white\_check\_mark: [athame](https://github.com/ardagnir/athame) ⭐ 1,653 | 🐛 23 | 🌐 C | 📅 2023-11-01 - Patches your shell to add full Vim support by routing your keystrokes through an actual Vim process.
* :white\_check\_mark: [Hints](https://github.com/AlfredoSequeida/hints) ⭐ 1,372 | 🐛 19 | 🌐 Python | 📅 2026-06-28 - Navigate GUI applications in Linux without your mouse by displaying "hints" you can type on your keyboard to interact with GUI elements (X11/Wayland)
* :white\_check\_mark: [sketchyvim](https://github.com/FelixKratz/SketchyVim) ⭐ 1,026 | 🐛 26 | 🌐 C | 📅 2024-03-16 - Get vim-like navigation in any macOS text field.
* :white\_check\_mark: [VimAction](https://github.com/pilyang/vim-action) ⭐ 11 | 🐛 4 | 🌐 Swift | 📅 2026-09-16 - Intercepts keystrokes system-wide and turns them into Vim modes, motions and operators in any macOS text field. Open source.
...
* :white\_check\_mark: [btop++](https://github.com/aristocratos/btop) ⭐ 34,689 | 🐛 544 | 🌐 C++ | 📅 2026-09-19 - A resource monitor. To enable Vim navigation, set in the config file:

  * ```ini
    vim_keys = True
    ```

* :white\_check\_mark: [CopyQ](https://github.com/hluk/CopyQ) ⭐ 12,290 | 🐛 397 | 🌐 C++ | 📅 2026-09-20 - A clipboard manager with basic Vim-like navigation.
...
* :white\_check\_mark: [vit](https://github.com/vit-project/vit) ⭐ 582 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - An TUI for [Taskwarrior](https://taskwarrior.org/) Vim-like keybindings.
...
* :white\_check\_mark: [alacritty](https://github.com/alacritty/alacritty) ⭐ 65,780 | 🐛 343 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, OpenGL terminal emulator with Vim-like keybindings by default.
* :white\_check\_mark: [tmux](https://github.com/tmux/tmux) ⭐ 49,412 | 🐛 42 | 🌐 C | 📅 2026-09-21 - the terminal multiplexer, superseding GNU Screen.
  * <details>
...
* :white\_check\_mark: [kakoune](https://github.com/mawww/kakoune) ⭐ 11,059 | 🐛 922 | 🌐 C++ | 📅 2026-09-15 - A modal text editor inspired by Vim-navigation.
...
* Emacs
  * :heavy\_plus\_sign: [doom emacs](https://github.com/doomemacs/doomemacs) ⭐ 22,692 | 🐛 481 | 🌐 Emacs Lisp | 📅 2026-09-06 - Configuration package that provides a similar experience to Spacemacs (including `evil-mode`. Also implements spacebar-as-leader-key.
...
* QTextEdit/QPlainTextEdit
  * :heavy\_plus\_sign: [FakeVim](https://github.com/hluk/FakeVim) ⭐ 183 | 🐛 21 | 🌐 C++ | 📅 2026-09-15
...
* [Inkdrop](https://www.inkdrop.app/) - A Markdown note-taking app.
  * :heavy\_plus\_sign: [inkdrop-vim](https://github.com/inkdropapp/inkdrop-vim) ⭐ 110 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-17 - Provides a Vim modal control for Inkdrop.
...
* ~~Atom~~ - [Discontinued](https://github.blog/2022-06-08-sunsetting-atom/)
  * :heavy\_plus\_sign: ~~[atom-vim-mode-plus](https://github.com/t9md/atom-vim-mode-plus) ⭐ 1,387 | 🐛 127 | 🌐 CoffeeScript | 📅 2021-10-07~~
...
* :white\_check\_mark: [nyxt](https://github.com/atlas-engineer/nyxt) ⭐ 11,020 | 🐛 145 | 🌐 Common Lisp | 📅 2026-02-26 - A keyboard-driven web browser inspired by Vim and Emacs.
...
* :white\_check\_mark: [wyeb](https://github.com/jun7/wyeb) ⭐ 127 | 🐛 11 | 🌐 C | 📅 2025-10-23 - A Vim-like webkit2gtk web browser.
...
* Chrome
  * :heavy\_plus\_sign: ~~[cVim](https://github.com/1995eaton/chromium-vim) ⭐ 2,254 | 🐛 326 | 🌐 JavaScript | 📅 2022-10-19~~
  ...
  * :heavy\_plus\_sign: ~~[ViChrome](https://github.com/k2nr/ViChrome) ⭐ 230 | 🐛 29 | 🌐 CoffeeScript | 📅 2017-03-18~~
...
* Various
  * :heavy\_plus\_sign: [firenvim](https://github.com/glacambre/firenvim) ⭐ 6,140 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-12 - Transform text areas into a Neovim instance that inherits your existing config (keymaps, plugins, etc).
...
* :heavy\_plus\_sign: [keyd](https://github.com/rvaiya/keyd) ⭐ 5,984 | 🐛 326 | 🌐 C | 📅 2026-06-01 - A key remapping daemon for Linux.
  * <details>
