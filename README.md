...
* [DBeaver](https://dbeaver.io/) - Free Universal Database Tool
  * :heavy\_plus\_sign: [Vrapper plugin](https://vrapper.sourceforge.net/home/) - Plugin adds vim bindings to SQL editor. Install it using instructions from <https://github.com/dbeaver/dbeaver/issues/8219> ⭐ 51,811 | 🐛 3,334 | 🌐 Java | 📅 2026-09-19
...
* :white\_check\_mark: [nnn](https://github.com/jarun/nnn) ⭐ 21,955 | 🐛 1 | 🌐 C | 📅 2026-09-19 - TUI file manager.
...
* [Visual Studio Code (VSCode)](https://code.visualstudio.com/)
  * :heavy\_plus\_sign: [VSCodeVim](https://marketplace.visualstudio.com/items?itemName=vscodevim.vim) - Vim emulation for Visual Studio Code. [GitHub](https://github.com/VSCodeVim/Vim) ⭐ 15,208 | 🐛 1,908 | 🌐 TypeScript | 📅 2026-09-19
  * :heavy\_plus\_sign: [VSCode Neovim](https://marketplace.visualstudio.com/items?itemName=asvetliakov.vscode-neovim) - Alternative to the VIM plugin, uses a full nvim instance in the background instead of just emulating VIM. [GitHub](https://github.com/vscode-neovim/vscode-neovim) ⭐ 7,740 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-19
...
* DrRacket - IDE for learning the Racket language.
  * :heavy\_plus\_sign: ~~[DrRacket Vim Tool](https://github.com/takikawa/drracket-vim-tool) ⭐ 217 | 🐛 40 | 🌐 Racket | 📅 2025-09-20~~ - An IDE that aims to use the tools you wish to use(including Vim and Emacs).
...
* :white\_check\_mark: [glow](https://github.com/charmbracelet/glow) ⭐ 27,385 | 🐛 235 | 🌐 Go | 📅 2026-09-14 - Terminal based markdown reader.
...
* :white\_check\_mark: [ly](https://github.com/fairyglade/ly) ⭐ 7,595 | 🐛 0 | 🌐 Zig | 📅 2026-09-08 - A TUI display manager. Supports vi-like movement. Edit this in your `/etc/ly/config.ini`
  ...
  * ```ini
    ...
    vi_mode = true
    ```
* :white\_check\_mark: [mdp](https://github.com/visit1985/mdp) ⭐ 5,277 | 🐛 7 | 🌐 C | 📅 2026-09-09 - A command-line based markdown presentation tool.
...
* :white\_check\_mark: [cmus](https://github.com/cmus/cmus) ⭐ 6,245 | 🐛 219 | 🌐 C | 📅 2026-08-12 - A console music player with vim-like [keybindings](https://man.archlinux.org/man/cmus.1.en#KEYBINDINGS).
* :white\_check\_mark: [ncmpcpp](https://github.com/ncmpcpp/ncmpcpp) ⭐ 2,482 | 🐛 225 | 🌐 C++ | 📅 2026-09-19 - An ncurses client for [mpd](https://www.musicpd.org/). The navigation can quite easily be made to behave like vim with some keyboard configurations.
  * <details>
...
* Spotify
  * :white\_check\_mark: [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,351 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - TUI for Spotify with Vim-like keybindings.
...
* :white\_check\_mark: [bat](https://github.com/sharkdp/bat) ⭐ 60,501 | 🐛 518 | 🌐 Rust | 📅 2026-09-04
* :white\_check\_mark: [less](https://en.wikipedia.org/wiki/Less_\(Unix\))

## PDF Viewers

* :white\_check\_mark: [Sioyek](https://github.com/ahrm/sioyek) ⭐ 9,873 | 🐛 330 | 🌐 C | 📅 2026-09-19 - Both keyboard and (optionally) mouse focused. Configurable and has the possibility of adding and developing plugins.
...
* :white\_check\_mark: [Trilium](https://github.com/zadam/trilium) ⭐ 37,902 | 🐛 675 | 🌐 TypeScript | 📅 2026-09-19 - 'Enable Vim Keybindings' added to Options in early-2022
...
* :white\_check\_mark: [iamb](https://github.com/ulyssa/iamb) ⭐ 1,287 | 🐛 115 | 🌐 Rust | 📅 2026-09-19 - A Matrix client for Vim addicts.
...
* :white\_check\_mark: [matui](https://github.com/pkulak/matui) ⭐ 124 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - a Matrix TUI with vim-like navigation.
...
* :white\_check\_mark: [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,479 | 🐛 1,034 | 🌐 Go | 📅 2026-09-19 - Simple terminal UI for git commands with Vim-like keybindings.

* :white\_check\_mark: [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,508 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 - GitUI provides you with the comfort of a git GUI but right in your terminal.
  * instruction how to enable vi bindings - <https://github.com/extrawurst/gitui/blob/master/KEY_CONFIG.md> ⭐ 22,508 | 🐛 347 | 🌐 Rust | 📅 2026-08-04

* :white\_check\_mark: [tig](https://jonas.github.io/tig/) - Text interface for git. Works mostly like vim out of the box, but can be enhanced by sourcing these [keybindings](https://github.com/jonas/tig/blob/master/contrib/vim.tigrc) ⭐ 13,343 | 🐛 231 | 🌐 C | 📅 2026-09-19 in your `~/.tigrc`.
...
* :white\_check\_mark: [Bash](https://www.gnu.org/software/bash/) - The preferred method is to set Vi mode in `~/.inputrc` via readline, as you will get Vi mode automatically in all programs using the library. However, if you just want this for bash, put this in your bash startup file e.g., `~/.bashrc`:
  ...
  * :heavy\_plus\_sign: [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,747 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 (Bash Line Editor) - An interactive plugin `ble.sh` provides a better Vim mode as well as syntax highlighting and autosuggestions.  In addition to the above setting of `set -o vi` in `~/.bashrc` or `set editing-mode vi` in `~/.inputrc`, you can add the following settings in `~/.bashrc` to enable `ble.sh`.
...
* :white\_check\_mark: [vim-anywhere](https://github.com/cknadler/vim-anywhere) ⭐ 3,768 | 🐛 43 | 🌐 Shell | 📅 2026-05-02 - Spawn a Vim buffer from any text input in the operating system.
* :white\_check\_mark: [warpd](https://github.com/rvaiya/warpd) ⭐ 3,631 | 🐛 108 | 🌐 C | 📅 2024-07-12 - A modal keyboard-driven interface for mouse manipulation, Linux (X11/Wayland)
...
* :white\_check\_mark: [btop++](https://github.com/aristocratos/btop) ⭐ 34,657 | 🐛 541 | 🌐 C++ | 📅 2026-09-19 - A resource monitor. To enable Vim navigation, set in the config file:

  * ```ini
    vim_keys = True
    ```

* :white\_check\_mark: [CopyQ](https://github.com/hluk/CopyQ) ⭐ 12,279 | 🐛 401 | 🌐 C++ | 📅 2026-09-19 - A clipboard manager with basic Vim-like navigation.
...
* :white\_check\_mark: [alacritty](https://github.com/alacritty/alacritty) ⭐ 65,764 | 🐛 340 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, OpenGL terminal emulator with Vim-like keybindings by default.
* :white\_check\_mark: [tmux](https://github.com/tmux/tmux) ⭐ 49,346 | 🐛 53 | 🌐 C | 📅 2026-09-19 - the terminal multiplexer, superseding GNU Screen.
  * <details>
...
* :white\_check\_mark: [kakoune](https://github.com/mawww/kakoune) ⭐ 11,057 | 🐛 921 | 🌐 C++ | 📅 2026-09-15 - A modal text editor inspired by Vim-navigation.
...
* Emacs
  * :heavy\_plus\_sign: [doom emacs](https://github.com/doomemacs/doomemacs) ⭐ 22,689 | 🐛 481 | 🌐 Emacs Lisp | 📅 2026-09-06 - Configuration package that provides a similar experience to Spacemacs (including `evil-mode`. Also implements spacebar-as-leader-key.
...
* :white\_check\_mark: [nyxt](https://github.com/atlas-engineer/nyxt) ⭐ 11,019 | 🐛 145 | 🌐 Common Lisp | 📅 2026-02-26 - A keyboard-driven web browser inspired by Vim and Emacs.
...
* Chrome
  * :heavy\_plus\_sign: ~~[cVim](https://github.com/1995eaton/chromium-vim) ⭐ 2,254 | 🐛 327 | 🌐 JavaScript | 📅 2022-10-19~~
...
* Various
  * :heavy\_plus\_sign: [firenvim](https://github.com/glacambre/firenvim) ⭐ 6,138 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-12 - Transform text areas into a Neovim instance that inherits your existing config (keymaps, plugins, etc).
...
* :heavy\_plus\_sign: [keyd](https://github.com/rvaiya/keyd) ⭐ 5,977 | 🐛 324 | 🌐 C | 📅 2026-06-01 - A key remapping daemon for Linux.
  * <details>
