...
* [DBeaver](https://dbeaver.io/) - Free Universal Database Tool
  * :heavy\_plus\_sign: [Vrapper plugin](https://vrapper.sourceforge.net/home/) - Plugin adds vim bindings to SQL editor. Install it using instructions from <https://github.com/dbeaver/dbeaver/issues/8219> ⭐ 51,643 | 🐛 3,360 | 🌐 Java | 📅 2026-09-03
...
* :white\_check\_mark: [nnn](https://github.com/jarun/nnn) ⭐ 21,857 | 🐛 4 | 🌐 C | 📅 2026-09-03 - TUI file manager.
* :white\_check\_mark: [ranger](https://github.com/ranger/ranger) ⭐ 17,387 | 🐛 897 | 🌐 Python | 📅 2026-08-31 - Another TUI file manager.
* :white\_check\_mark: [lf](https://github.com/gokcehan/lf) ⭐ 9,484 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - TUI file manager similar to ranger.
* :white\_check\_mark: [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,816 | 🐛 13 | 🌐 Rust | 📅 2026-08-25 - TUI file manager.
* :white\_check\_mark: [felix](https://github.com/kyoheiu/felix) ⭐ 916 | 🐛 29 | 🌐 Rust | 📅 2025-04-12 - TUI file manager.
...
* [Visual Studio Code (VSCode)](https://code.visualstudio.com/)
  * :heavy\_plus\_sign: [VSCodeVim](https://marketplace.visualstudio.com/items?itemName=vscodevim.vim) - Vim emulation for Visual Studio Code. [GitHub](https://github.com/VSCodeVim/Vim) ⭐ 15,207 | 🐛 1,907 | 🌐 TypeScript | 📅 2026-09-03
  * :heavy\_plus\_sign: [VSCode Neovim](https://marketplace.visualstudio.com/items?itemName=asvetliakov.vscode-neovim) - Alternative to the VIM plugin, uses a full nvim instance in the background instead of just emulating VIM. [GitHub](https://github.com/vscode-neovim/vscode-neovim) ⭐ 7,729 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31
* :white\_check\_mark: [XCode](https://developer.apple.com/xcode/) - Apple's IDE. Vim mode can be enabled under the "Editor" menu without the use of plugins.
  * :heavy\_plus\_sign: ~~[XVim](https://github.com/XVimProject/XVim) ⭐ 5,119 | 🐛 305 | 🌐 Objective-C | 📅 2018-01-09~~ plugin. Deprecated, use native keybindings (above) instead.
...
* [Geany](https://www.geany.org/)
  * :heavy\_plus\_sign: [vimode](https://github.com/geany/geany-plugins/blob/master/vimode/README) ⭐ 644 | 🐛 336 | 🌐 C | 📅 2026-07-11 - The vimode plugin can be enabled from the settings.
...
* :white\_check\_mark: [glow](https://github.com/charmbracelet/glow) ⭐ 27,171 | 🐛 229 | 🌐 Go | 📅 2026-09-02 - Terminal based markdown reader.
* :white\_check\_mark: [fx](https://github.com/antonmedv/fx) ⭐ 20,617 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Terminal based JSON viewer.
* :white\_check\_mark: [gollum](https://github.com/gollum/gollum) ⭐ 14,320 | 🐛 91 | 🌐 Ruby | 📅 2025-11-24 - A Git-powered wiki with built-in Vim editing mode. Start with `--default-keybind vim`.
* :white\_check\_mark: [ly](https://github.com/fairyglade/ly) ⭐ 7,564 | 🐛 0 | 🌐 Zig | 📅 2026-08-27 - A TUI display manager. Supports vi-like movement. Edit this in your `/etc/ly/config.ini`
  ...
  * ```ini
    ...
    vi_mode = true
    ```
* :white\_check\_mark: [mdp](https://github.com/visit1985/mdp) ⭐ 5,275 | 🐛 13 | 🌐 C | 📅 2025-07-09 - A command-line based markdown presentation tool.
...
* Spotify
  * :white\_check\_mark: [spotify-tui](https://github.com/Rigellute/spotify-tui) ⭐ 19,340 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - TUI for Spotify with Vim-like keybindings.
...
* :white\_check\_mark: [bat](https://github.com/sharkdp/bat) ⭐ 60,363 | 🐛 424 | 🌐 Rust | 📅 2026-09-01
* :white\_check\_mark: [less](https://en.wikipedia.org/wiki/Less_\(Unix\))

## PDF Viewers

* :white\_check\_mark: [Sioyek](https://github.com/ahrm/sioyek) ⭐ 9,826 | 🐛 325 | 🌐 C | 📅 2026-08-18 - Both keyboard and (optionally) mouse focused. Configurable and has the possibility of adding and developing plugins.
...
* :white\_check\_mark: [Trilium](https://github.com/zadam/trilium) ⭐ 37,694 | 🐛 708 | 🌐 TypeScript | 📅 2026-09-03 - 'Enable Vim Keybindings' added to Options in early-2022
...
* :white\_check\_mark: [iamb](https://github.com/ulyssa/iamb) ⭐ 1,274 | 🐛 168 | 🌐 Rust | 📅 2026-09-02 - A Matrix client for Vim addicts.
...
* :white\_check\_mark: [Lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,953 | 🐛 1,028 | 🌐 Go | 📅 2026-09-02 - Simple terminal UI for git commands with Vim-like keybindings.

* :white\_check\_mark: [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,461 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - GitUI provides you with the comfort of a git GUI but right in your terminal.
  * instruction how to enable vi bindings - <https://github.com/extrawurst/gitui/blob/master/KEY_CONFIG.md> ⭐ 22,461 | 🐛 343 | 🌐 Rust | 📅 2026-08-04

* :white\_check\_mark: [tig](https://jonas.github.io/tig/) - Text interface for git. Works mostly like vim out of the box, but can be enhanced by sourcing these [keybindings](https://github.com/jonas/tig/blob/master/contrib/vim.tigrc) ⭐ 13,319 | 🐛 232 | 🌐 C | 📅 2026-07-27 in your `~/.tigrc`.
...
* :white\_check\_mark: [Bash](https://www.gnu.org/software/bash/) - The preferred method is to set Vi mode in `~/.inputrc` via readline, as you will get Vi mode automatically in all programs using the library. However, if you just want this for bash, put this in your bash startup file e.g., `~/.bashrc`:
  ...
  * :heavy\_plus\_sign: [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,670 | 🐛 84 | 🌐 Shell | 📅 2026-08-18 (Bash Line Editor) - An interactive plugin `ble.sh` provides a better Vim mode as well as syntax highlighting and autosuggestions.  In addition to the above setting of `set -o vi` in `~/.bashrc` or `set editing-mode vi` in `~/.inputrc`, you can add the following settings in `~/.bashrc` to enable `ble.sh`.
...
* :white\_check\_mark: [zsh](https://en.wikipedia.org/wiki/Z_shell) - just put this in your ZSH startup file, most likely `~/.zshrc`:
  ...
  * :heavy\_plus\_sign: [zsh-vi-mode](https://github.com/jeffreytse/zsh-vi-mode) ⭐ 4,441 | 🐛 131 | 🌐 Shell | 📅 2026-07-19 - A better and friendlier Vim-mode plugin for zsh.
...
* :white\_check\_mark: [Hints](https://github.com/AlfredoSequeida/hints) ⭐ 1,360 | 🐛 19 | 🌐 Python | 📅 2026-06-28 - Navigate GUI applications in Linux without your mouse by displaying "hints" you can type on your keyboard to interact with GUI elements (X11/Wayland)
...
* :white\_check\_mark: [VimAction](https://github.com/pilyang/vim-action) ⭐ 8 | 🐛 1 | 🌐 Swift | 📅 2026-09-02 - Intercepts keystrokes system-wide and turns them into Vim modes, motions and operators in any macOS text field. Open source.
...
* :white\_check\_mark: [btop++](https://github.com/aristocratos/btop) ⭐ 34,390 | 🐛 532 | 🌐 C++ | 📅 2026-09-01 - A resource monitor. To enable Vim navigation, set in the config file:

  * ```ini
    vim_keys = True
    ```

* :white\_check\_mark: [CopyQ](https://github.com/hluk/CopyQ) ⭐ 12,212 | 🐛 407 | 🌐 C++ | 📅 2026-09-02 - A clipboard manager with basic Vim-like navigation.
...
* :white\_check\_mark: [alacritty](https://github.com/alacritty/alacritty) ⭐ 65,611 | 🐛 338 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, OpenGL terminal emulator with Vim-like keybindings by default.
* :white\_check\_mark: [tmux](https://github.com/tmux/tmux) ⭐ 49,035 | 🐛 32 | 🌐 C | 📅 2026-09-02 - the terminal multiplexer, superseding GNU Screen.
  * <details>
...
* Emacs
  * :heavy\_plus\_sign: [doom emacs](https://github.com/doomemacs/doomemacs) ⭐ 22,647 | 🐛 477 | 🌐 Emacs Lisp | 📅 2026-09-03 - Configuration package that provides a similar experience to Spacemacs (including `evil-mode`. Also implements spacebar-as-leader-key.
...
* QTextEdit/QPlainTextEdit
  * :heavy\_plus\_sign: [FakeVim](https://github.com/hluk/FakeVim) ⭐ 183 | 🐛 22 | 🌐 C++ | 📅 2026-08-31
...
* [Inkdrop](https://www.inkdrop.app/) - A Markdown note-taking app.
  * :heavy\_plus\_sign: [inkdrop-vim](https://github.com/inkdropapp/inkdrop-vim) ⭐ 110 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-03 - Provides a Vim modal control for Inkdrop.
...
* :white\_check\_mark: [nyxt](https://github.com/atlas-engineer/nyxt) ⭐ 11,014 | 🐛 145 | 🌐 Common Lisp | 📅 2026-02-26 - A keyboard-driven web browser inspired by Vim and Emacs.
...
* Chrome
  * :heavy\_plus\_sign: ~~[cVim](https://github.com/1995eaton/chromium-vim) ⭐ 2,255 | 🐛 327 | 🌐 JavaScript | 📅 2022-10-19~~
...
* Various
  * :heavy\_plus\_sign: [firenvim](https://github.com/glacambre/firenvim) ⭐ 6,116 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-04 - Transform text areas into a Neovim instance that inherits your existing config (keymaps, plugins, etc).
...
* :heavy\_plus\_sign: [keyd](https://github.com/rvaiya/keyd) ⭐ 5,934 | 🐛 319 | 🌐 C | 📅 2026-06-01 - A key remapping daemon for Linux.
  * <details>
